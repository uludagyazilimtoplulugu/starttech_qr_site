...
class StantlarPage extends ConsumerStatefulWidget {
  const StantlarPage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _StantlarPageState();
}

class _StantlarPageState extends ConsumerState<StantlarPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  content: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: const InputDecoration(
                          labelText: 'Stant Açıklaması',
                        ),
                      ),
                      TextFormField(
                        controller: photoUrlController,
                        decoration: const InputDecoration(
                          labelText: 'Stant Fotoğrafı',
                        ),
                      ),
                      TextFormField(
                    ...
                    isLoading
                        ...
                        : TextButton(
                            onPressed: () async {
                              ...
                              setState(() {});
                              await FirestoreService().addStantToFirestore(
      ...
      body: Center(
        child: FutureBuilder(
          future: FirestoreService().getStants(),
